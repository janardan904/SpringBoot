...
public class ProductRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		repo.findByProdCost(3.4,mydata.class).forEach(ex->System.out.println(ex.getProdCode()+","+ex.getProdModel()));
		   	
       repo.findByProdCode("A",MyView.class).forEach(t1->System.out.println(t1.getProdCost()+"   "+t1.getProdVendor()));		
